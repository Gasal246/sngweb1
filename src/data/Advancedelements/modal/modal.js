...
import * as formelement from "../../Form/formelement/formelement";
//MessagePreview
...
//ExtralargeModal
export function ExtralargeModal({openModal,handleCloseModal,modalTitle=null}) {
  const [show, setShow] = useState(openModal ? openModal : false);
    ...
    <>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button variant="primary"  onClick={() => handleModal(false)}>
            Save changes
          </Button>
        </Modal.Footer>
      </Modal>
