                ...
                <div className="mb-6 productdesc">
                    ...
                    <ul className="list-unstyled mb-2">
                        ...
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.camp_address ? data?.camp?.camp_address : "-"}</div>
                        </li>
                        <li className="row">
                            <div className="text-muted  col-xl-3 col-lg-4 col-sm-3">Camp City</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.camp_city ? data?.camp?.camp_city : "-"}</div>
                        </li>
                        <li className="row">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">No Of Allowed User</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.no_of_allowed_user ? data?.camp?.no_of_allowed_user : "-"}</div>
                        </li>
                        <li className="row">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">No Of Allowed Kiosk</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.no_of_allowed_kiosk ? data?.camp?.no_of_allowed_kiosk : "-"}</div>
                        </li>
                        <li className="row">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">No Of Allowed Account</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.no_of_allowed_account ? data?.camp?.no_of_allowed_account : "-"}</div>
                        </li>
                        <li className="row">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">No Of Allowed Coordinators</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.no_of_allowed_coordinators ? data?.camp?.no_of_allowed_coordinators : "-"}</div>
                        </li>
                        <li className="row">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Access Of Package Meal</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.camp?.is_allowed_package_meal.toString() === "1" ? "green" : "red"} fs-15 fw-semibold`}>{IsAccess(data?.camp?.is_allowed_package_meal.toString())}</span>
                            </div>
                        </li>
                        <li className="row">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Access Of Package Water</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.camp?.is_allowed_package_water.toString() === "1" ? "green" : "red"} fs-15 fw-semibold`}>{IsAccess(data?.camp?.is_allowed_package_water.toString())}</span>
                            </div>
                        </li>
                        <li className="row">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Access Of Package Internet</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.camp?.is_allowed_package_internet.toString() === "1" ? "green" : "red"} fs-15 fw-semibold`}>{IsAccess(data?.camp?.is_allowed_package_internet.toString())}</span>
                            </div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Package Status</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.camp?.status.toString() === "1" ? "green" : "red"} fs-15 fw-semibold`}>{statusCheck(data?.camp?.status.toString())}</span>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul className="list-unstyled mb-2">
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_ssid ? data?.camp?.router_ssid : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Router Primary IP</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_primary_ip ? data?.camp?.router_primary_ip : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Router Secondary IP</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_secondary_ip ? data?.camp?.router_secondary_ip : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Router Mac Address</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_mac_address ? data?.camp?.router_mac_address : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Router Pass</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_pass ? data?.camp?.router_pass : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Router Secret</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_secret ? data?.camp?.router_secret : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Router Alias</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_alias ? data?.camp?.router_alias : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Router Hostname</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp?.router_hostname ? data?.camp?.router_hostname : "-"}</div>
                        </li>
                    </ul>
                </div>
            </Modal.Body>
