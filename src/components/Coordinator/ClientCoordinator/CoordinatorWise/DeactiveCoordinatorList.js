    ...
    const columns = [
        {
            ...
            cell: row => <div className="d-flex">
                <div className="ms-2 mt-0 mt-sm-2 d-block">
                    <h6 className="mb-0 fs-14 fw-semibold">{row.camp.camp_name}</h6>
                </div>
            </div>
        },
        {
            ...
            sortable: true,
            cell: row => <span className="text-muted fs-15 fw-semibold">{row.camp.camp_address}</span>
        },
        {
            name: "CITY",
            selector: row => [row.camp.camp_city],
            sortable: true,
            cell: row => <span className="text-muted fs-15 fw-semibold">{row.camp.camp_city}</span>
        },
        {
            name: "CREATED AT",
            selector: row => [row.camp.createdAt],
            sortable: true,
            cell: row => <span className="text-muted fs-15 fw-semibold">{row.camp.createdAt}</span>
        },
        {
        ...
        {
            name: "STATUS",
            selector: row => [row.camp.status],
            sortable: true,
            cell: row => <span className={`text-${row.camp.status.toString() === "1" ? "green" : "red"} fs-15 fw-semibold`}>{statusCheck(row.camp.status.toString())}</span>
        },
        {
            name: "ACTION",
