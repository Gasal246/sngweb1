...
function ViewModal(props) {
    const { show, handleCloseModal, data, campsList } = props

    return (
        <Modal size="xl" show={show}>
            <Modal.Header>
                <div className="modal-title h4 mb-0">Coordinator Information</div>
                ...
                <div className="mb-6 productdesc">
                    <ul className="list-unstyled mb-0">
                        ...
                        {data?.camp_id && <li className="row">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.camp_id ? getKeyName(campsList, data?.camp_id)[0].label : "-"}</div>
                        </li>}

                        <li className="row">
                            <div className="text-muted  col-xl-3 col-lg-4 col-sm-3">ID</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.coordinator?.id ? data?.coordinator?.id : "-"}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Full Name</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.coordinator?.full_name ? data?.coordinator?.full_name : '-'}</div>
                        </li>
                        <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Email</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">{data?.coordinator?.email ? data?.coordinator?.email : '-'}</div>
                        </li>
                        ...
                        {data?.coordinator?.status && <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3"> Status</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.coordinator?.status.toString() === "1" ? "green" : "red"} fs-15 fw-semibold`}>{statusCheck(data?.coordinator?.status.toString())}</span>
                            </div>
                        </li>
                        }
                        {data?.status && <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Assigned Status</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                        ...
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.coordinator?.is_mess_management ? (data?.coordinator?.is_mess_management.toString() === "1" ? "green" : "red") : 'red'} fs-15 fw-semibold`}>{IsAccess(data?.coordinator?.is_mess_management ? (data?.coordinator?.is_mess_management.toString()) : '0')} </span>
                            </div>
                        </li>
                        ...
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.coordinator?.is_water_management ? (data?.coordinator?.is_water_management.toString() === "1" ? "green" : "red") : 'red'} fs-15 fw-semibold`}>{IsAccess(data?.coordinator?.is_water_management ? (data?.coordinator?.is_water_management.toString()) : '0')} </span>
                            </div>
                        </li>
                        ...
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.coordinator?.is_internet_management ? (data?.coordinator?.is_internet_management.toString() === "1" ? "green" : "red") : 'red'} fs-15 fw-semibold`}>{IsAccess(data?.coordinator?.is_internet_management ? (data?.coordinator?.is_internet_management.toString()) : '0')} </span>
                            </div>
                        </li>
                        ...
                        {data?.is_investor_management && <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Access Of Investor Management</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.is_investor_management === "1" ? "green" : "red"} fs-15 fw-semibold`}>{IsAccess(data?.is_investor_management)} </span>
                            </div>
                        </li>}
