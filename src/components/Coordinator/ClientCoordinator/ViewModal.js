...
function ViewModal(props) {
    ...
    return (
        <Modal size="xl" show={show}>
            <Modal.Header>
                <div className="modal-title h4 mb-0">Cordinator Information</div>
            ...
            <Modal.Body className="p-5">
                <div className="mb-6 productdesc">
                    <ul className="list-unstyled mb-0">
                        ...
                        {data?.assigned_status && <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Assigned Status</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.assigned_status.toString() === "1" ? "green" : "red"} fs-15 fw-semibold`}>{statusCheck(data?.assigned_status.toString())}</span>
                            </div>
                        </li>
                        }
                        ...
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data.is_mess_management ? (data.is_mess_management.toString() === "1" ? "green" : "red") : 'red'} fs-15 fw-semibold`}>{IsAccess(data.is_mess_management ? (data?.is_mess_management.toString()) : '0')} </span>
                            </div>
                        </li>
                        ...
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data.is_water_management ? (data.is_water_management.toString() === "1" ? "green" : "red") : 'red'} fs-15 fw-semibold`}>{IsAccess(data.is_water_management ? (data?.is_water_management.toString()) : '0')} </span>
                            </div>
                        </li>
                        ...
                        <li className="row p-b-20">
                            ...
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data.is_internet_management ? (data.is_internet_management.toString() === "1" ? "green" : "red") : 'red'} fs-15 fw-semibold`}>{IsAccess(data.is_internet_management ? (data?.is_internet_management.toString()) : '0')} </span>
                            </div>
                        </li>
