...
function CampsClientWiseList({ data, handleView }) {
    ...
    const columns = [
        {
            ...
            cell: row => <div className="d-flex">
                <div className="ms-2 mt-0 mt-sm-2 d-block">
                    <h6 className="mb-0 fs-14 fw-semibold">{row?.camp_name ? row?.camp_name : '-'}</h6>
                </div>
            </div>
        },
        {
            ...
            cell: row => <div className="d-flex">
                <div className="ms-2 mt-0 mt-sm-2 d-block">
                    <h6 className="mb-0 fs-14 fw-semibold">{row?.camp_address ? row?.camp_address : '-'}</h6>
                </div>
            </div>
        },
        {
            ...
            cell: row => <div className="d-flex">
                <div className="ms-2 mt-0 mt-sm-2 d-block">
                    <h6 className="mb-0 fs-14 fw-semibold">{row?.camp_city ? row?.camp_city : '-'}</h6>
                </div>
            </div>
        },
        {
...
export default CampsClientWiseList;