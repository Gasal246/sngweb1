...
function ActiveList({ _USER, handleEditClick, data, handleDelete, handleView, handleAssignInternet, handleStatus }) {
    const columns = [
        {
            name: "PACKAGE NAME",
        ...
        },
        {
            ...
            sortable: true,
            cell: row => <span className="wd-lg-10">
                <OverlayTrigger placement="top" overlay={<Tooltip >Edit</Tooltip>}>
                    <Link onClick={() => handleEditClick(row)} to="#" className="btn btn-primary btn-sm rounded-11 me-2" >
                        <i>
                ...
                <OverlayTrigger placement="top" overlay={<Tooltip >Delete</Tooltip>}>
                    <Link to="#" onClick={() => handleDelete(row)} className="btn btn-danger btn-sm rounded-11 me-2">
                        <i>
                ...
                <OverlayTrigger placement="top" overlay={<Tooltip >View</Tooltip>}>
                    <Link to="#" onClick={() => handleView(row)} className="btn btn-info btn-sm rounded-11 me-2">
                        <i>
                ...
                {_USER?.user_data?.client_id === '0' && <OverlayTrigger placement="top" overlay={<Tooltip >Assign Client</Tooltip>}>
                    <Link to="#" onClick={() => handleAssignInternet(row)} className="btn btn-dark btn-sm rounded-11">
                        <i>
