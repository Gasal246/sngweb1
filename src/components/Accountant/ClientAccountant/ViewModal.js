...
function ViewModal(props) {
    ...
    return (
        <Modal size="xl" show={show}>
            <Modal.Header>
                <div className="modal-title h4 mb-0">Accountant Information</div>
            ...
            <Modal.Body className="p-5">
                <div className="mb-6 productdesc">
                    <ul className="list-unstyled mb-0">
                        ...
                        {data?.is_mess_management && <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Access Of Mess Management</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.is_mess_management === "1" ? "green" : "red"} fs-15 fw-semibold`}>{IsAccess(data?.is_mess_management)} </span>
                            </div>
                        </li>
                        }

                        {data?.is_water_management && <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Access Of Water Management</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.is_water_management === "1" ? "green" : "red"} fs-15 fw-semibold`}>{IsAccess(data?.is_water_management)} </span>
                            </div>
                        </li>}
                        {data?.is_internet_management && <li className="row p-b-20">
                            <div className="text-muted col-xl-3 col-lg-4 col-sm-3">Access Of Internet Management</div>
                            <div className="col-xl-3 col-lg-8 col-sm-3">
                                <span className={`text-${data?.is_internet_management === "1" ? "green" : "red"} fs-15 fw-semibold`}>{IsAccess(data?.is_internet_management)} </span>
                            </div>
                        </li>}
